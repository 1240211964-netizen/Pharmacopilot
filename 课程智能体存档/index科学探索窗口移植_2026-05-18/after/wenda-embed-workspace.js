...
"react-dom/client": function(require, module, exports) {
/**
 * @license React
...
exports.WENDA_DEFAULT_AGENT_ID = "6f5b49b6-5cb4-11f0-9ae8-fa163f087fa9";
...
function getRuntimeWendaDomain() {
...
function buildWendaUrl(config) {
    ...
    if (imageIds.length)
        params.set("image_ids", JSON.stringify(imageIds));
    if (fileIds.length)
...
"src/components/integrations/WendaEmbedWorkspace": function(require, module, exports) {
"use strict";
...
"src/wenda-embed-entry": function(require, module, exports) {
"use strict";
